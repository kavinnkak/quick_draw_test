...
document.getElementById('sketch_drawing').innerText = 'Sketch To be Drawn: ' + sketch;
...
function updateCanvas() {
    ...
    $('#sketch_drawing').text('Sketch to be drawn: ' + quick_draw_data_set[Math.floor(Math.random() * quick_draw_data_set.length)]);
}

// Function to check sketch
function checkSketch() {
    timer_counter++;
    $('#timer').text('Timer: ' + timer_counter);
